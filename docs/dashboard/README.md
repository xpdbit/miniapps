...
- AI-Tavern: 角色卡审核 / API 密钥审计 / AI 模型管理（含编辑/批量编辑）/ 用户管理
- 数据统计看板 (按项目过滤)
- 审计日志 / 系统监控
...
| Tavern Model Manager | `/tavern/models` | AI 模型管理（编辑/批量编辑/行选择） |
...
---
> **最后更新**: 2026-05-31
> 修改: TavernModelManager 新增编辑弹窗/批量编辑/行选择 — displayName/icon/description/sortOrder 字段支持
