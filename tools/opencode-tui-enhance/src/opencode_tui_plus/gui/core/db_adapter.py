...
class OceDBAdapter:
    ...
    # src/opencode_tui_plus/gui/core/db_adapter.py → 5 levels up = .miniapps/
    SUPER_TASK_PATH = Path(__file__).resolve().parents[5] / "supertask" / "gui" / "core"
