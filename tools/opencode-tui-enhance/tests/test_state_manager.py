...
import tempfile
import pytest
from opencode_tui_plus.core.state_manager import (
    StateManager, TaskState, TaskStatus, RoundStatus, RoundInfo
)
...
class TestStateManager:
    ...
    def test_task_lifecycle(self, sm):
        """完整生命周期：创建 → 执行两轮 → 完成"""
    ...
    def test_auto_complete_on_timeout(self, sm):
        """耗时超过时间上限 → 自动完成"""
    ...
    def test_recoverable_tasks(self, sm):
    ...
    def test_diff_file_saved(self, sm):
    ...
    def test_backup_recovery(self, sm):
