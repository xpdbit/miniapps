...
export default function PersonaPage() {
  ...
  return (
    <View className='page-persona'>
      ...
      {/* Modal */}
      {modalVisible && (
        <View className='page-persona-modal-mask' onClick={closeModal}>
          <View className='page-persona-modal' onClick={e => e.stopPropagation()}>
            ...
            <View className='page-persona-modal-actions'>
              <Button className='page-persona-modal-cancel' onClick={closeModal}>取消</Button>
              <Button
                className='page-persona-modal-confirm'
