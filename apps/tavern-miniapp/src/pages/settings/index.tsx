...
const PROVIDERS = [
  ...
  { key: 'openrouter', name: 'OpenRouter', icon: '🛤️' },
] as const
...
export default function SettingsPage() {
  ...
  return (
    <View className='page-settings'>
      ...
      {/* 添加 Key 弹窗 */}
      {showModal && (
        <View className='page-settings-modal-mask' onClick={() => setShowModal(false)}>
          <View className='page-settings-modal' onClick={e => e.stopPropagation()}>
            ...
            <View className='page-settings-modal-actions'>
              <Text className='page-settings-modal-cancel' onClick={() => setShowModal(false)}>
                取消
              </Text>
              <Text
                className={`page-settings-modal-confirm ${verifying ? 'loading' : ''}`}
