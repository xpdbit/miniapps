...
echo " 恢复完成!"
echo "=========================================="
echo " Dashboard(HTTP):  http://47.94.108.150/"
echo " Dashboard(HTTPS): https://47.94.108.150/"
echo " Dashboard(域名):  https://mnapp.top/"
echo " API:              https://mnapp.top/api/ftl/api/v1/"
echo " Game1:            https://game1.mnapp.top/"
echo " 默认管理员:       admin / Admin123!"
echo ""
echo "⚠️  如果 HTTPS 仍未就绪，请通过 HTTP 访问："
echo "   http://47.94.108.150/"
echo "   然后重新运行 SSL 配置：bash /opt/ftg/deploy/scripts/setup-ssl.sh"
echo "=========================================="
